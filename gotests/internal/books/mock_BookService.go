...
// Book provides a mock function with given fields: ctx, id
func (_m *MockBookService) Book(ctx context.Context, id int64) (*models.Book, error) {
...
func (_m *MockBookService) ListBooks(ctx context.Context) ([]*models.Book, error) {
	ret := _m.Called(ctx)
...
func (_m *MockBookService) SaveBook(ctx context.Context, book *models.Book) error {
